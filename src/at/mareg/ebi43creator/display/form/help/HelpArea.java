...
public class HelpArea extends TextArea
{
  ...
  private void initHelpTexts ()
  {
    ...
    helpTexts.put (EFormElement.INVOICE_DATE.getID (),
                   "Hier können Sie das Rechnugsdatum angeben. Voreingestellt " +
    ...
    helpTexts.put (EFormElement.BILLER_CONTACT.getID (), "Hier können sie eine zuständigen Ansprechperson eingeben.");
     ...
     */
    helpTexts.put (EFormElement.DETAILS_LINE_ORDERPOSITIONNUMER.getID (),
                   "Die \"Pos.Nr. der Bestellung\" ist " +
    ...
    /*
     * DiscountSurchargePane - discount line
     */
    helpTexts.put (EFormElement.DISCOUNT_PERCENT.getID (),
                   "Bitte geben sie hier die Prozente an, die vom Gesamtrechnung abgezogen werden dürfe, wenn eine Bezahlung " +
                                                           "bis zu dem im Feld \"bei Bezahlung bis\" ausgewählten Datum erfolgt.\n\n" +
                                                           "Der Wert in diesem Feld muss größer 0 und kleiner 100 sein.\n\nWenn Werte " +
                                                           "kleiner oder gleich 0 und Werte größer oder gleich 100 eingegeben werden, " +
                                                           "wird das Feld automatisch wieder gelöscht.\n\nEs können maximal 2 Skontoeinträge " +
                                                           "eingegeben werden\n\nWenn es sich hier bereits um die zweite Skontozeile handelt, " +
                                                           "werden hier nur Werte größer 0 und kleiner des Wertes der ersten Skontozeile akzeptiert." +
                                                           "\n\nHinweis, falls dies die zweite Skontozeile ist:\nWenn Sie den Prozentwert der ersten " +
                                                           "Zeile auf einen Wert ändern, der kleiner als der Wert dieser Zeile ist, wird der " +
                                                           "Wert dieser Zeile entfernt.");

    helpTexts.put (EFormElement.DISCOUNT_UNTIL_DATE.getID (),
                   "Bitte geben sie hier an bis zu welchen Datum die Bezahlung der Rechnung erfolgen muss um den im Feld " +
                                                              "\"Prozent Skonto\" angegebenen Wert von der Gesamtrechnung abziehen zu dürfen.\n\n" +
                                                              "Die Datumswerte sind ebenfalss voneinander abhängig. Das Datum der ersten Skontozeile kann " +
                                                              "nicht kleiner als das heutige Datum sein. Das ist deshalb so, weil die Laufzeit des Skontos " +
                                                              "erst am Tag der Einbringung zu Laufen beginnt (dieses Datum ist i.d.R. gleich dem Erstellungs" +
                                                              "datum.\n\nDas Datum der zweiten Skontozeile kann nicht vor dem Datum der ersten Skontozeile " +
                                                              "liegen, daher haben Sie beim Auswählen des Datums nur mehr die Möglichkeit ein Datum nach dem " +
                                                              "Datum des ersten Skontoeintrages auszuwählen.\n\nWenn Skontoeinträge vorhanden sind wird auch " +
                                                              "das Fälligkeitsdatums netto im gleichnamigen Abschnitt zum Pflichtfeld.\n\nHinweis: Wenn Sie " +
                                                              "Skonti verwenden und das Datum auf einen Wert sezten der über dem Datum des zweiten Skontoeintrages " +
                                                              "liegt, wird dieser entfernt. Dasselbe gilt auch für das Nettofälligkeitsdatum, wenn bei den Skonto " +
                                                              "einträgen ein Datum ausgewählt wird, welches nach dem eingtragenen Fälligkeitsdatum liegt.");

    /*
     * DiscountSurchargePane - due date
     */
