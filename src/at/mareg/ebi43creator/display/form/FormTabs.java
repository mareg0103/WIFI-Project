...
public class FormTabs extends BorderPane
{
	...
	public FormTabs (final OrderPane op, final ContactPane bp, final PaymentPane pp, final DetailsPane dp,
			final SurchargeDiscountPane sdp, final SummaryPane sp, final HelpArea area, final ResourceManager resman)
	{
		orderPane = op;
		billerPane = bp;
		paymentPane = pp;
