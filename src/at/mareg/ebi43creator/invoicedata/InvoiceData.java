...
@XmlType (propOrder = { "invoiceNumber", "invoiceDate", "delivery", "biller", "invoiceRecipient", "details",
		"surchargeList", "tax", "totalGrossAmount", "payableAmount", "paymentMethod", "paymentConditions", "comment" })
public class InvoiceData
{
	...
	public void setTempData ()
	{
		...
		totalGrossAmount = Double
				.valueOf (tax.getVatItems ().get (0).getTaxedAmount () + tax.getVatItems ().get (0).getAmount ());
